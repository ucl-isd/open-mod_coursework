...
$string['alert_no_extension'] = 'No more extensions found.';
$string['alert_personaldeadline_save_successful'] = 'Personal deadline saved successfully!.';
...
$string['assessor_1'] = 'Assessor 1';
$string['assessor_2'] = 'Assessor 2';
...
$string['coursework_allocation_strategy_group_assessor'] = 'Assessor from Moodle course group assigned to Stage 1';
...
$string['gradeeditingtime_help'] = 'The amount of time given to allow for editing of grade after it is first saved and submitted. NOTE: The edit your own initial grades capability overrides this option allowing a user to edit at all times';
...
$string['notification_leave_form_title'] = 'Confirm';
$string['notification_leave_form_message'] = 'Changes you made may not be saved. Are you sure to leave this form anyway?';
$string['notification_info'] = 'Info';
...
$string['studentviewcomponentfeedbacks'] = 'Students can view assessors\' feedback';
...
$string['studentviewmoderatorfeedbacks'] = 'Students can view moderator feedback';
...
$string['yoursubmissionfile_renamed'] = '(this will be automatically renamed)';
